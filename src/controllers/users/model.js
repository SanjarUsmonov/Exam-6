...
const getUserByLimit =
  "SELECT * from users where user_craeted_at between '$1' and '$2' offset $3 limit $4";
const updateUser =
...
const getUserByLimitFetch = (from, to) => fetch(getUserByLimit, from, to);
